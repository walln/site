...
import Latex from "../../components/post/Latex.astro";
import LatexInLine from "../../components/post/LatexInLine.astro";
...
- <LatexInLine formula="\alpha_i" /> and <LatexInLine formula="\alpha_i^*" />
