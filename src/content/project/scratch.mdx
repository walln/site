...
- MultiQueryAttention as proposed in [Fast Transformer Decoding: One Write-Head is All You Need.](https://arxiv.org/abs/1911.02150) This is one of my favorites, Noam Shazeer's strikes isAPropagatingComponent, just look how simple this is: <Latex formula="
...
First defining the SSD layers as a selective SSM, building on the foundations of SSMs and the work from the original paper using selectiv scans:
