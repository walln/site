...
This is a collection of ML models and methods implemented from scratch for my learning and reference.
I use this project to digest new technologies and research as well as just to implement things for fun. 
...
If you want to suggest something for my roadmap, please open an issue on [GitHub](https://github.com/walln/scratch/issues).

## Update: July 2024

I have fully migrated the entire project to being written in JAX. Flax's new `NNX` API seems really promising and I 
...
Using a graph with reference semantics to enable intuitive Module Graph operations such as weight tying, 
...
I have fully moved over all of the deep learning models to using NNX and have added some new models as well. 
Additionally, I have moved the more tradtional ML methods over to using JAX as well.
...
Examples such as theese are on my roadmap.
...
This includes models used in a variety of different applications such as text generation, classification, and summarization. 
I intend to add new models and reimplement them. I plan to add GPT-2, GPT-Neo, LLaMA, Mistral/Mixtral, 
...
I really found interesting and of high quality such as MPT, T5, Mixture of Depths, and more. Gemma 2 seems like an 
...
LLama has been the foundation of so much research as well as engineering developments. This is most notable in the movement towards
...
The work the team primarily out of Allen Institute for Artificial Intelligence (AI2) and the University of Washington did is honestly groundbreaking. 
...
Even though the model is not SOTA, it is still really impressive and has lots of interesting notes about training a large scale model. 
Many of the issues they face are not really relevenat on the JAX stack that I implemented but forcing me to consider them and highlight the 
...
The details of the paper are fascinating and my implementation is annotated to attempt to make clear how the decomposition of the SSM 
